...
def home():
    ...
    return render_template(
        ...
        user_all_forums=user_all_forums
    )
...
def pub_view_Forum(deck_id):
   forum = Forum.query.get_or_404(deck_id)
   comment = Forum.comment
   return render_template('flashCards/pub_view_forum.html', forum = forum, comment = comment)
